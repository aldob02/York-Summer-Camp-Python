...
# __lt__ returns True if self is "less that" other. The same goes for __gt__, and __eq__
# for "greater than" and "equal". Try comparing two cards as card1 < card2.
# This means that we can sort a list of cards by passing it into a sort function.

# We create a Suit class and a Number class which will help compare cards.
class Suit:
